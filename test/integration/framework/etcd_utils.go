...
func NewDefaultEtcdStorage(client FakeClient, prefix string) storage.Interface {
	//if client == nil {
	//	client = NewEtcdClient()
	//}
	//return etcdstorage.NewEtcdStorage(client, testapi.Batch.Codec(), etcdtest.PathPrefix(), false)
	st, _ := (&etcdstorage.EtcdStorageConfig{
		Config: etcdstorage.EtcdConfig{
			Prefix: prefix,
		},
...
func NewAutoscalingEtcdStorage(client FakeClient) storage.Interface {
	//if client == nil {
	//	client = NewEtcdClient()
	//}
	...
	st, _ := (&etcdstorage.EtcdStorageConfig{
		Config: etcdstorage.EtcdConfig{},
		Codec:  testapi.Autoscaling.Codec(),
	}).NewStorage()
	
	return st
}

func NewBatchEtcdStorage(client FakeClient) storage.Interface {
	//if client == nil {
	//	client = NewEtcdClient()
	//}
	//return etcdstorage.NewEtcdStorage(client, testapi.Batch.Codec(), etcdtest.PathPrefix(), false)
	st, _ := (&etcdstorage.EtcdStorageConfig{
		Config: etcdstorage.EtcdConfig{},
		Codec:  testapi.Batch.Codec(),
	}).NewStorage()
	
	return st
}

func NewExtensionsEtcdStorage(client FakeClient) storage.Interface {
	//if client == nil {
	//	client = NewEtcdClient()
	//}
